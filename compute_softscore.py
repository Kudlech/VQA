"""
https://github.com/SKTBrain/BAN-KVQA/blob/master/tools/compute_softscore.py
"""
...
def filter_answers(answers_dset, min_occurence):
    ...
    for answer in occurence.keys():
        if len(occurence[answer]) < min_occurence:
            answers_to_del.append(answer)
    occurence = {k: v for k, v in occurence.items() if k not in answers_to_del}
